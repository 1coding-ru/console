...
define("ace/mode/_1c_highlight_rules", function (require, exports, module) {
  ...
  var _1CHighlightRules = function () {
    var keywords =
      ...
      "перем|знач|и|или|не|из|новый|выполнить|прервать|продолжить|возврат|экспорт|вызватьисключение" +
    ...
    var builtinFunctions =
      ...
      "тип|типзнч|показатьвопрос|вопрос|предупреждение|сообщить|структура|соответствие|массив|";
    var dataTypes =
